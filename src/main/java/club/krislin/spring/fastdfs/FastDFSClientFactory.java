...
public class FastDFSClientFactory implements PooledObjectFactory<FastDFSClient> {
    ...
    public PooledObject<FastDFSClient> makeObject() throws Exception {
        ...
        //连接超时的时限，单位为毫秒
        ClientGlobal.setG_connect_timeout(fastDfsConfiguration.getConnect_timeout() * 1000);
        //网络超时的时限，单位为毫秒
        ClientGlobal.setG_network_timeout(fastDfsConfiguration.getNetwork_timeout() * 1000);
        //字符集
        ClientGlobal.setG_charset(fastDfsConfiguration.getCharset());
